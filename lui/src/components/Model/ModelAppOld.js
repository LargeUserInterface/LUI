...
require('./mech-drone/source/Drone.zip/Drone_ao.jpg');
require('./mech-drone/source/Drone.zip/Drone_diff.jpg');
require('./mech-drone/source/Drone.zip/Drone_emissive.jpg');
require('./mech-drone/source/Drone.zip/Drone_gloss.jpg');
require('./mech-drone/source/Drone.zip/Drone_normal.jpg');
require('./mech-drone/source/Drone.zip/Drone_spec.jpg');
require('./mech-drone/source/Drone.zip/Fire_Alpha.jpg');
require('./mech-drone/source/Drone.zip/Fire_Dif.jpg');
require('./mech-drone/textures/Drone_ao.jpeg');
require('./mech-drone/textures/Drone_diff.jpeg');
require('./mech-drone/textures/Drone_emissive.jpeg');
require('./mech-drone/textures/Drone_gloss.jpeg');
require('./mech-drone/textures/Drone_normal.jpeg');
require('./mech-drone/textures/Drone_spec.jpeg');
require('./mech-drone/textures/Fire_Alpha.jpeg');
require('./mech-drone/textures/Fire_Dif.jpeg');
...
class ModelApp extends React.Component {
  ...
  componentDidMount() {
    ...
    loader.load(fbxUrl, function (object) {
      ...
      var objectControls = new _this.LeapObjectControls(camera, object);
  ...
  LeapCameraControls(camera) {
    ...
    // this.rotateHands = 1;
    // this.rotateFingers = [2, 5];
    // this.rotateRightHanded = false;
    this.rotateHandPosition = true;
    this.rotateStabilized = false;
    this.rotateMin = 0;
    this.rotateMax = Math.PI;
